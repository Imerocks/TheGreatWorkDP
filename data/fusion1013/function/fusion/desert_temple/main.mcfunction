...
execute as @e[tag=dt_sacrifice_1] unless score @s item_sacrifice matches 1 run scoreboard players set sacrifice_1 desert_temple 0
...
execute as @e[tag=dt_sacrifice_2] unless score @s item_sacrifice matches 1 run scoreboard players set sacrifice_2 desert_temple 0
...
execute as @e[tag=dt_sacrifice_3] unless score @s item_sacrifice matches 1 run scoreboard players set sacrifice_3 desert_temple 0
